        ...
        content: `
            ...
            <form method="POST">
                <div>
                    ...
                    <div class="form-floating">
                        <input name="passwordConfirmation" type="password" class="form-control" id="floatingInput" placeholder="Password confirmation">
                        <label for="floatingPassword">Password confirmation</label>
                        <p class="text-danger">${getError(errors, 'passwordConfirmation')}</p>
                    </div>
                    <div class="my-3">
                        <button class="btn btn-primary mb-3 px-5 py-3">Sign up</button>
                    </div>
                </div>
            </form>
